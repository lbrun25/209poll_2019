...
func Poll() {
	...
	p = PStruct{
		populationSize:       a.pSize,
		sampleSize:           a.sSize,
		votingIntentions:     a.p,
		variance:             variance,
		confidenceInterval95:  getConfidentInterval(1.96, variance),
		confidenceInterval99:  getConfidentInterval(2.58, variance),
	}
